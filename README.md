...
> 基于 Vue 3 + Spring Boot 3 的 AI 辅助实验教学管理平台

## 项目简介

Agent for Labex 是一个功能完整的实验教学管理系统，集成了 AI 代码执行服务和文档生成能力。系统从旧有的 Spring MVC + JSP 架构重构为现代化的前后端分离架构，支持教师和学生的全流程实验教学管理。
...
### AI 服务
- **代码执行**：支持 Python/Java 等多语言代码在线执行
- **向量嵌入**：基于文本的语义检索和相似度匹配
- **文档生成**：自动生成实验报告和个人成绩单
